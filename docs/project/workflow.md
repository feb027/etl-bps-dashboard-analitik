...
1. Write review prompt output to `docs/reviews/REVIEW_phaseX.md`.
2. Fix critical and important issues.
3. Run validation commands again.
4. If needed, write final verification review to `docs/reviews/REVIEW_phaseX_final.md`.
5. Update `docs/project/project-control.md`.
